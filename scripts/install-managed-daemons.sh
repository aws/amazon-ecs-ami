...
if [ -z "$MANAGED_DAEMON_BASE_URL" ]; then
    host_suffix=""
...
curl -fLSs -o "$WORK_DIR/${CSI_DRIVER_FILENAME}.asc" "${CSI_DRIVER_FULL_URL}.asc"
...
gpg --verify "$WORK_DIR/${CSI_DRIVER_FILENAME}.asc" "$WORK_DIR/${CSI_DRIVER_FILENAME}" || true
